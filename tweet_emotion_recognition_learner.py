...
Original file is located at
    https://colab.research.google.com/drive/1712R9bGsKomoijOU9y5p4f4cqRggh0qA
...
test_eval=model.evaluate(test_seq,test_labels)
...
clsses_x=np.argmax(preds,axis=1)

show_confusion_matrix(test_labels,clsses_x,list(classes))